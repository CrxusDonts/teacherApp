<template>
  <div>
    ...
    <el-header class="title">
      ...
      <ChoiceQuestion v-for="(choiceQuestion, index) in this.choiceQuestions" v-bind:choiceQuestion="choiceQuestion"
                      v-bind:order="order++"></ChoiceQuestion>
      <CompletionQuestion v-for="(completionQuestion, index) in this.completionQuestions" v-bind:completionQuestion="completionQuestion"
                      v-bind:order="order++"></CompletionQuestion>
      <SubjectiveQuestion v-for="(subjectiveQuestion, index) in this.subjectiveQuestions" v-bind:subjectiveQuestion="subjectiveQuestion"
                          v-bind:order="order++"></SubjectiveQuestion>
    </el-header>
  </div>
</template>
